...
/********-*********-*********-*********-*********-*********-*********/
// program:    URSC642-00av1_Rosenheim_Homework7-2019-01-18.do
// task:       Replication of Homework 7 
// Homework: Problems 11.1 11.2, Acock, 3rd edition
// version:    Second Draft - install listcoef
...
/* Set Provenance                                                   */
/*------------------------------------------------------------------*/
global dofilename URSC642-00av1_Rosenheim_Homework7-2019-01-18
...
* To add listcoef use the command:
findit listcoef
net install spost9_ado.pkg, replace
listcoef, help percent
